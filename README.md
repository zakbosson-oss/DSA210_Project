...
The final dataset contains one observation per video and forms the basis for all
subsequent analysis.
...
How does video duration relate to total views and engagement rates?

Does upload timing (hour of day) influence average video performance?

Are there systematic performance differences across channels within the same niche?

Are low-performing videos random outcomes, or do they share common structural characteristics?

How do engagement metrics differ between low-performing and typical-performing videos?
